...
const Footer: React.FC<ScrollToTopProps> = ({
  onTopScroll,
}) => {
  return (
    <footer className='bg-[#36312b] w-full'>
      <div className='mx-auto 2xl:max-w-[1440px] mobile:p-8  xsmobile:p-4'>
        {/*footer nav link*/}
        <div className='font-spoqaHangSans flex justify-between items-center'>
          ...
          {/* 소셜미디어 링크 */}
          <div className='flex'>
            <div className='sm:flex sm:items-center sm:block xsmobile:hidden '>
              <Link
        ...
        {/*footer description*/}
        <div>
          <p className='pt-8 mb-2 text-white font-medium xsmobile:text-sm'>
            (주) 베스펙스
          </p>
          <p className='mb-2 text-white font-medium xsmobile:text-sm'>
          ...
          {/*모바일 환경 소셜 링크 */}
          <Gap size='py-4 sm:hidden xsmobile:block' />
          <div className='sm:hidden xsmobile:block xsmobile:flex xsmobile:justify-center'>
            <Link
              href='https://www.instagram.com/signaling.couple/'
              target='_blank'
              rel='noopener noreferrer'
